  ...
  return (
    <div>
      <Menu fixed="top" inverted>
        <Container>
          <Menu.Item position='left' as="a" header href="/">
            COVID-19 Global Daily Stats by Country
          </Menu.Item>
          <Menu.Item position='left' as="a" header href="/province">Daily Stats by Province</Menu.Item>
          {authState.isAuthenticated && userInfo && (
          <Menu.Item id="messages-button" position='right' as="a" href="/messages">
